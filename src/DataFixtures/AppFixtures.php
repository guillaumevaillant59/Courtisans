...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $carte1->setpath("asset/image/papillons/papillon_normal.jpg");
        $carte2= new Carte();
        $carte2->setFamille("Papillon");
        $carte2->setRole("Noble");
        $carte2->setpath("asset/image/papillons/papillon_noble.jpg");
        $carte3= new Carte();
        $carte3->setFamille("Papillon");
        $carte3->setRole("Assassin");
        $carte3->setpath("asset/image/papillons/papillon_assassin.jpg");
        $carte4= new Carte();
        $carte4->setFamille("Papillon");
        $carte4->setRole("Protecteur");
        $carte4->setpath("asset/image/papillons/papillon_protecteur.jpg");
        $carte5= new Carte();
        $carte5->setFamille("Papillon");
        $carte5->setRole("Espion");
        $carte5->setpath("asset/image/papillons/papillon_espion.jpg");
        $carte6= new Carte();
        $carte6->setFamille("Crapaud");
        $carte6->setRole("Normal");
        $carte6->setpath("asset/image/crapauds/crapaud_normal.jpg");
        $carte7= new Carte();
        $carte7->setFamille("Crapaud");
        $carte7->setRole("Noble");
        $carte7->setpath("asset/image/crapauds/crapaud_noble.jpg");
        $carte8= new Carte();
        $carte8->setFamille("Crapaud");
        $carte8->setRole("Assassin");
        $carte8->setpath("asset/image/crapauds/crapaud_assassin.jpg");
        $carte9= new Carte();
        $carte9->setFamille("Crapaud");
        $carte9->setRole("Protecteur");
        $carte9->setpath("asset/image/crapauds/crapaud_protecteur.jpg");
        $carte10= new Carte();
        $carte10->setFamille("Crapaud");
        $carte10->setRole("Espion");
        $carte10->setpath("asset/image/crapauds/crapaud_espion.jpg");
        $carte11= new Carte();
        $carte11->setFamille("Rossignol");
        $carte11->setRole("Normal");
        $carte11->setpath("asset/image/rossignols/rossignol_normal.jpg");
        $carte12= new Carte();
        $carte12->setFamille("Rossignol");
        $carte12->setRole("Noble");
        $carte12->setpath("asset/image/rossignols/rossignol_noble.jpg");
        $carte13= new Carte();
        $carte13->setFamille("Rossignol");
        $carte13->setRole("Assassin");  
        $carte13->setpath("asset/image/rossignols/rossignol_assassin.jpg");
        $carte14= new Carte();
        $carte14->setFamille("Rossignol");
        $carte14->setRole("Protecteur");
        $carte14->setpath("asset/image/rossignols/rossignol_protecteur.jpg");
        $carte15= new Carte();
        $carte15->setFamille("Rossignol");
        $carte15->setRole("Espion");
        $carte15->setpath("asset/image/rossignols/rossignol_espion.jpg");
        $carte16= new Carte();
        $carte16->setFamille("Cerf");
        $carte16->setRole("Normal");
        $carte16->setpath("asset/image/cerfs/cerf_normal.jpg");
        $carte17= new Carte();
        $carte17->setFamille("Cerf");
        $carte17->setRole("Noble");
        $carte17->setpath("asset/image/cerfs/cerf_noble.jpg");
        $carte18= new Carte();
        $carte18->setFamille("Cerf");
        $carte18->setRole("Assassin");
        $carte18->setpath("asset/image/cerfs/cerf_assassin.jpg");
        $carte19= new Carte();
        $carte19->setFamille("Cerf");
        $carte19->setRole("Protecteur");
        $carte19->setpath("asset/image/cerfs/cerf_protecteur.jpg");
        $carte20= new Carte();
        $carte20->setFamille("Cerf");
        $carte20->setRole("Espion");
        $carte20->setpath("asset/image/cerfs/cerf_espion.jpg");
        $carte21= new Carte();
        $carte21->setFamille("Lapin");
        $carte21->setRole("Normal");
        $carte21->setpath("asset/image/lapins/lapin_normal.jpg");
        $carte22= new Carte();
        $carte22->setFamille("Lapin");
        $carte22->setRole("Noble");
        $carte22->setpath("asset/image/lapins/lapin_noble.jpg");
        $carte23= new Carte();
        $carte23->setFamille("Lapin");
        $carte23->setRole("Assassin");
        $carte23->setpath("asset/image/lapins/lapin_assassin.jpg");
        $carte24= new Carte();
        $carte24->setFamille("Lapin");
        $carte24->setRole("Protecteur");
        $carte24->setpath("asset/image/lapins/lapin_protecteur.jpg");
        $carte25= new Carte();
        $carte25->setFamille("Lapin");
        $carte25->setRole("Espion");
        $carte25->setpath("asset/image/lapins/lapin_espion.jpg");
        $carte26= new Carte();
        $carte26->setFamille("Carpe");
        $carte26->setRole("Normal");
        $carte26->setpath("asset/image/carpes/carpe_normal.jpg");
        $carte27= new Carte();
        $carte27->setFamille("Carpe");
        $carte27->setRole("Noble");
        $carte27->setpath("asset/image/carpes/carpe_noble.jpg");
        $carte28= new Carte();
        $carte28->setFamille("Carpe");
        $carte28->setRole("Assassin");
        $carte28->setpath("asset/image/carpes/carpe_assassin.jpg");
        $carte29= new Carte();
        $carte29->setFamille("Carpe");
        $carte29->setRole("Protecteur");
        $carte29->setpath("asset/image/carpes/carpe_protecteur.jpg");
        $carte30= new Carte();
        $carte30->setFamille("Carpe");
        $carte30->setRole("Espion");
        $carte30->setpath("asset/image/carpes/carpe_espion.jpg");
        ...
        $missionBlanche1->setPath("asset/image/missions_blanches/blanche_1.jpg");
        ...
        $missionBlanche2->setPath("asset/image/missions_blanches/blanche_2.jpg");
        ...
        $missionBlanche3->setPath("asset/image/missions_blanches/blanche_3.jpg");
        ...
        $missionBlanche4->setPath("asset/image/missions_blanches/blanche_4.jpg");
        ...
        $missionBlanche5->setPath("asset/image/missions_blanches/blanche_5.jpg");
        ...
        $missionBleue7->setPath("asset/image/missions_bleues/bleue_7.jpg");
        ...
        $missionBleue8->setPath("asset/image/missions_bleues/bleue_8.jpg");
        ...
        $missionBleue9->setPath("asset/image/missions_bleues/bleue_9.jpg");
        ...
        $missionBleue10->setPath("asset/image/missions_bleues/bleue_10.jpg");
